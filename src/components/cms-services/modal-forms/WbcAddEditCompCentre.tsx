...
type WbcAddEditCompCentreProps = {
  district: string;
  yctcName: string;
  yctcCode: string | number | readonly string[] | undefined;
  centreCategory: string | number | readonly string[] | undefined;
  address1: string | number | readonly string[] | undefined;
  address2: string | number | readonly string[] | undefined;
  address3: string | number | readonly string[] | undefined;
  city: string | number | readonly string[] | undefined;
  pincode: string | number | readonly string[] | undefined;
  inchargeName: string | number | readonly string[] | undefined;
  inchargeMobile: string | number | readonly string[] | undefined;
  inchargeEmail: string | number | readonly string[] | undefined;
  ownerName: string | number | readonly string[] | undefined;
  ownerMobile: string | number | readonly string[] | undefined;
};
...
const WbcAddEditCompCentre = ({ editId }: { editId?: number }) => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    setIsLoading(true);
    try {
      const response = await customFetch.post(`/comp-centres`, data);
      ...
      <DialogContent className="sm:max-w-xl">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mt-2.5 flex flex-col justify-start items-start">
            <div className="w-full grid grid-cols-2 gap-4">
              <div className="col-span-1 flex flex-col justify-start items-start gap-2">
                <Label htmlFor="inchargeName" className="text-muted-foreground">
                  Centre inchage name
                </Label>
                <Input
                  name="inchargeName"
          ...
          <div className="mt-2.5 flex flex-col justify-start items-start">
            <div className="w-full grid grid-cols-2 gap-4">
              ...
              <div className="col-span-1 flex flex-col justify-start items-start gap-2">
                <Label htmlFor="ownerMobile" className="text-muted-foreground">
