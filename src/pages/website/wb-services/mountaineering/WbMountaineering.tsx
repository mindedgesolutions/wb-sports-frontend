        ...
        <WbContentWrapper title="WB Mountaineering & Adventure Sports Foundation">
          <div className="flex flex-col gap-8 text-sm md:text-base tracking-wider leading-relaxed text-justify">
            <p className="text-sky-foreground font-medium tracking-wider">
              Welcome To West Bengal Mountaineering & Adventure Sports
              Foundation
            </p>
            <p>
            ...
            <p>
              The aims and objectives of this Foundation is to help and
              encourage the Youth of this State in 'Adventure Sports',
              Expedition and Exploration of diverse nature and in fostering
              among them a spirit of camaraderie, good neighbourly relations,
              sacrifice for a noble cause, self discipline, self respect and
              respect for freedom and integrity of the nation. Further, the
              Foundation will support, promote and execute schemes for
              mountaineering, skiing, rock-climbing, altitude trekking, hang
              gliding, jungle safari, coastal trekking, river rafting, sea
              surfing including exploration under the seas, cycling, motor
              cycling, touring, aero sports etc. for the youth and give
              financial assistance to individual family members of mountaineers
              or explorers etc. involved in an accident.
            </p>
            <ol
              content="a"
