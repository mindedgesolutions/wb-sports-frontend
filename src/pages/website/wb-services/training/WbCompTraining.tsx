      ...
      <WbPageWrapper>
        ...
        <WbContentWrapper title="Youth Computer Training Centre">
          ...
          <p>
            ...
            different private organizations play an important role in providing
            low cost computer training to the student-youth across the state
            enabling them to prepare themselves fit for employment. About 1,000
            (One Thousand) Youth Computer Training centres are now running
            across the state. Every year thousands of student-youth are getting
            themselves eligible to survive in the competitive job market
            successfully being trained from these training centres in various
            courses.
          </p>
          <p>
            ...
            organization has been entrusted upon to conduct the entire system of
            online examination and evaluation thereof. Introduction of this
            ...
            large extent. The students are getting their certificates downloaded
            online. This new initiative of the Department has brought
            revolutionary changes in the entire education system of these Youth
          ...
          <p>
            ...
            introducing more new relevant courses. Proposals in this regard are
            being invited from interested individuals or organizations subject
            to fulfilling the following mandatory conditions :
          </p>
          <ol content="1" className="list-decimal space-y-4 ml-8 font-medium">
            <li>
              The distance from the already existing centre to the proposed new
              centre should be at least 3 kilometres in case of rural areas and
              at least 1 kilometre in case of municipal areas.
            </li>
            <li>
              There should be provision for a premise of at least 1500 sq. ft.
              of area, which will have separate toilets for boys and girls and a
              specific space for an office room.
            </li>
            <li>
              Supporting documents regarding the proprietorship of the room or
              rent paid has to be submitted.
            </li>
            <li>Still photo and sketch map of the room has to be submitted.</li>
            <li>
              The applicant should produce the documents regarding his computer
              knowledge.
            </li>
            <li>
              Photograph of atleast 2(two) nos. of Faculty Members and documents
              of their educational qualification along with complete bio-data
              has to be submitted.
            </li>
            <li>
